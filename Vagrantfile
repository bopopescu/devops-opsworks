...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  #   chef.data_bags_path = "../my-recipes/data_bags"
      ...
      #chef.add_recipe "ri_riak::leave"
      #chef.add_recipe "ri_riak::force_remove"

      #chef.add_recipe "ri_python_django::reset_databases"
      #chef.add_recipe "ri_python_django::reset_staticdatabase"
